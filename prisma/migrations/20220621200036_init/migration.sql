...
CREATE TABLE "CONTRATO" (
    "id" SERIAL NOT NULL,
    "data_inicio" TEXT NOT NULL DEFAULT E'20002202',
    "data_fim" TEXT NOT NULL DEFAULT E'20002202',
    "natureza" TEXT DEFAULT E'',
    "pec" TEXT NOT NULL DEFAULT E'',
    "descricao_pec" TEXT NOT NULL DEFAULT E'',
    "grupo_cliente" TEXT NOT NULL DEFAULT E'',
    "empresa" TEXT NOT NULL DEFAULT E'',
    "negocio" TEXT NOT NULL DEFAULT E'',
    "seguros" VARCHAR(1200) NOT NULL DEFAULT E'',
    "doc_solid" VARCHAR(1200) NOT NULL DEFAULT E'',
    "retencao_contrato" TEXT NOT NULL DEFAULT E'',
    "faturamento" TEXT NOT NULL DEFAULT E'',
    "tipo_faturamento" TEXT NOT NULL DEFAULT E'',
    "reajuste1" TEXT NOT NULL DEFAULT E'',
    "mes_reajuste1" TEXT NOT NULL DEFAULT E'',
    "perc_reajuste1" DECIMAL(15,2),
    "reajuste2" TEXT NOT NULL DEFAULT E'',
    "mes_reajuste2" TEXT NOT NULL DEFAULT E'',
    "perc_reajuste2" DECIMAL(15,2),
    "reajuste3" TEXT NOT NULL DEFAULT E'',
    "mes_reajuste3" TEXT NOT NULL DEFAULT E'',
    "perc_reajuste3" DECIMAL(15,2),
    "tipo_ass" TEXT NOT NULL DEFAULT E'',
    "status" TEXT NOT NULL DEFAULT E'',
    "status_pec" INTEGER DEFAULT 0,
    "resumo" TEXT NOT NULL DEFAULT E'',
    ...
    "reajuste_comparar1" TEXT NOT NULL DEFAULT E'',
    "mes_reajuste_comparar1" TEXT NOT NULL DEFAULT E'',
    "perc_reajuste_comparar1" DECIMAL(15,2),
    "id_reajuste_comparar2" INTEGER NOT NULL DEFAULT 0,
    "reajuste_comparar2" TEXT NOT NULL DEFAULT E'',
    "mes_reajuste_comparar2" TEXT NOT NULL DEFAULT E'',
    "perc_reajuste_comparar2" DECIMAL(15,2),
    "id_reajuste_comparar3" INTEGER NOT NULL DEFAULT 0,
    "reajuste_comparar3" TEXT NOT NULL DEFAULT E'',
    "mes_reajuste_comparar3" TEXT NOT NULL DEFAULT E'',
    "perc_reajuste_comparar3" DECIMAL(15,2),
    "data_inicio_comparar" TEXT NOT NULL DEFAULT E'',
    "data_fim_comparar" TEXT NOT NULL DEFAULT E'',
    "deleted" BOOLEAN NOT NULL DEFAULT false,
    "id_siga" TEXT NOT NULL DEFAULT E'',
